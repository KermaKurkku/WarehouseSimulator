package simulator.view.animation;
...
public class StationWithList {
	...
	public void drawSubRectangles(int count)
	{
		...
		Point2D location = new Point2D.Double(mainRectangle.getX()-5, mainRectangle.getY());
		for (int i = 0; i < count; i++)
		{
			...
			if (i != 0) 
			{
				location = new Point2D.Double(location.getX()-5, location.getY());
			}
		}
	}
